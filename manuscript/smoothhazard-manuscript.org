...
|    2 | Interval-censored ill time, right-censored death time |          1 |          0 | $L_i$ | $R_i$ | $C_i$ | $L_i<R_i$; $R_i\le C_i$ |
|    3 | Exact ill time, right-censored death time             |          1 |          0 | $L_i$ | $L_i$ | $C_i$ | $L_i\le C_i$            |
|    4 | Interval-censored ill time, death time observed       |          1 |          1 | $L_i$ | $R_i$ | $T_i$ | $L_i<R_i$; $R_i\le T_i$ |
