...
library(lava)
set.seed(17)
u <- idmModel(K=10,lambda=1/100,schedule=15,punctuality=1/20)
distribution(u,"lifetime") <- coxWeibull.lvm(lambda=1/100,nu=3)
...
distribution(u,"lifetime") <- coxWeibull.lvm(lambda=1/120000,nu=2.5)
## distribution(u,"waittime") <- coxWeibull.lvm(lambda=1/120000,nu=2.5)
## distribution(u,"waittime") <- coxExponential.lvm(lambda=1/120)
distribution(u,"waittime") <- coxWeibull.lvm(lambda=1/120,nu=1.5)
distribution(u,"illtime") <- coxWeibull.lvm(lambda=1/120,nu=1.5)
